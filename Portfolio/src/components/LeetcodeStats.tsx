...
const LeetcodeStats = ({
  ...
  const StatsContent = () => (
    <div className="bg-gradient-to-br from-primary/5 via-background to-primary/5 p-2 sm:p-4 w-full max-w-full overflow-y-auto">
      ...
      <div className="flex flex-wrap gap-3 w-full overflow-y-auto items-start">
        <div className="text-center flex-1 space-y-2 min-w-[140px]">
          {/* ... (Keep Profile Link and Circular Progress) ... */}
    ...
    <>
      ...
      <div className="max-sm:hidden sm:block">
        <HoverCard openDelay={200} closeDelay={100}>
          ...
          <HoverCardContent
            align="end"
            className="max-w-[650px] w-[90vw] p-0 border-2 border-primary/20 shadow-2xl shadow-primary/10 rounded-2xl overflow-hidden"
            sideOffset={8}
          >
            <StatsContent />
          </HoverCardContent>
      ...
      <div className="block sm:hidden">
        <Dialog>
          ...
          <DialogContent className="w-[95vw] max-w-[420px] h-[calc(100dvh-4rem)] overflow-y-auto p-0 border-2 border-primary/20 shadow-2xl shadow-primary/10 rounded-2xl">
